...
func TestFunctionCurveSum(t *testing.T) {
	...
	sensors.SensorMap.Set(s1.GetId(), s1)
	...
	sensors.SensorMap.Set(s2.GetId(), s2)
	...
	SpeedCurveMap.Set(functionCurve.GetId(), functionCurve)
